# Generated by Django 2.2.7 on 2019-11-16 11:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.PositiveIntegerField(choices=[(1, 'Partner'), (2, 'Organization'), (3, 'Superuser')], verbose_name='role')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='created')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='updated')),
                ('organization', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='credit.CreditOrganization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send', models.DateTimeField(verbose_name='sending date')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='created')),
        ...
        migrations.AddField(
            ...
            name='partner',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='credit.Partner'),
        ),
    ]
